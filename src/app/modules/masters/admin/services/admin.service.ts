...
export class AdminService {
  ...
  getAdmins(
    ...
    return this.http
      .get<ResponseModel<AdminModel[]>>(
        `${environment.baseURL}Admin/GetAllAdmin`,
        {
          params,
        }
      )
  ...
  getAdminById(id: number) {
    return this.http.get<ResponseModel<AdminModel>>(
      `${environment.baseURL}Admin/GetAdminById/${id}`
    );
  }
